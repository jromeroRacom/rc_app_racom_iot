...
export class HeaderComponent implements OnInit, AfterViewInit {
  ...
  defaultFlag!: string;
  flagNewNotification: boolean;                   // Flag para mostrar notificaciones
  ...
  constructor(
    ...
    this.langStoreValue = '';
    this.flagNewNotification = false;            // Quita icono de notificaciones
  }
  ...
  ngOnInit(): void {
    ...
    const val = this.listLang.filter((x: any) => x.lang === this.langStoreValue);
